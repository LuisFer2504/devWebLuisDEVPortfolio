  ...
  return (
    <>
      <GlassCard hoverGlow>
        ...
        >
          ...
          <div
            ...
            className={`relative overflow-hidden bg-surface-container-low cursor-pointer group/image ${
          ...
          >
            {hasMultipleImages ? (
              <>
                ...
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 z-10 p-2.5 rounded-full bg-background/40 backdrop-blur-md border border-outline-variant/30 text-on-surface hover:bg-background/70 hover:scale-110 active:scale-95 transition-all opacity-0 group-hover/image:opacity-100 focus:opacity-100 hover:text-primary"
                >
                  <ChevronLeft size={20} />
                </button>
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 z-10 p-2.5 rounded-full bg-background/40 backdrop-blur-md border border-outline-variant/30 text-on-surface hover:bg-background/70 hover:scale-110 active:scale-95 transition-all opacity-0 group-hover/image:opacity-100 focus:opacity-100 hover:text-primary"
                >
                  <ChevronRight size={20} />
                </button>

                {/* Indicators (Dots) */}
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 flex gap-1.5 px-3 py-1.5 rounded-full bg-background/50 backdrop-blur-md border border-outline-variant/20 shadow-lg">
            ...
            {/* Expand Overlay Badge (Hover & Mobile friendly) */}
            <div className="absolute top-3 right-3 z-10 p-2 rounded-xl bg-background/60 backdrop-blur-md border border-outline-variant/30 text-on-surface opacity-80 group-hover/image:opacity-100 group-hover/image:scale-105 transition-all shadow-md">
              <Maximize2 size={16} />
            </div>
          </div>
      ...
      <ImageModal
        ...
        onSelectIndex={(index) => setCurrentImageIndex(index)}
      />
    </>
  );
}
